...
export async function fetchPageProps(slug: string): Promise<{ props: IPageProps }> {
...
export async function getStaticPaths() {
  // Fetch the list of slugs from your CMS or define them
  const slugs = ['etusivu', 'palvelut', 'yhteystiedot', 'blog']; // Replace with actual slugs

  // Map the slugs to params for the paths
  ...
  return {
    paths,
    fallback: false, // or 'blocking' if you want to SSR new paths at request time
  };
}
